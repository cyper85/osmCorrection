...
define("correctionObject", ["require", "exports"], function (require, exports) {
    "use strict";
...
(function (f) {
    ...
    console.log("low");
define("main2", ["require", "exports", "osmauth", "correctionTool"], function (require, exports, osmAuth, correctionTool_1) {
    "use strict";
    var auth = osmAuth({
    ...
    (function () {
        ...
        correctionTool = new correctionTool_1.correctionToolClass();
        map = L.map('map', {
